...
TASKS = {
    "a": [(x, math.sin(7 * x) * math.cos(5 * x) + 0.3 * x**4 + 0.2 * abs(x**2) + 0.1 * x**3 * math.sin(2 * x)) for x in _XS],
    "b": [(x, math.sin(13 * x) * math.cos(7 * x) + 0.4 * x**3 + 0.2 * abs(x) + 0.1 * x**5 + 0.05 * x**2 * math.sin(3 * x)) for x in _XS],
